  ...
  return (
    <div>
      <ValidatorForm
        name="form"
        onSubmit={e => {
          props.persistDao(props.publicAddress, {...props.dao}, props.user._id, props.web3, props.access_token, props.daoFactoryContractAbi, props.daoFactoryContractAddress)
        }}
